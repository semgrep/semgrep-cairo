...
(**
    Functions for parsing cairo programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a cairo program from a string into a typed OCaml CST.
...
(** Parse a cairo program from a file into a typed OCaml CST.
